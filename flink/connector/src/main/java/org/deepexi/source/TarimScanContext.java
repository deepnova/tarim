...
public class TarimScanContext implements Serializable {
    ...
    boolean datafileFromIceberg() {
        return datafileFromIceberg;
    }
    ...
    TarimScanContext copyWithAppendsBetween(long newStartSnapshotId, long newEndSnapshotId) {
        return TarimScanContext.builder()
    ...
    TarimScanContext copyWithSnapshotId(long newSnapshotId) {
        return TarimScanContext.builder()
                .caseSensitive(caseSensitive)
    ...
    static class Builder {
        ...
        Builder fromProperties(Map<String, String> properties) {
            ...
            return this.useSnapshotId(config.get(SNAPSHOT_ID))
                    ...
                    .datafileFromIceberg(config.get(DATAFILE_FROM_ICEBERG));
        }

        public TarimScanContext build() {
