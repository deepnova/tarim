...
import org.deepexi.metadata.TarimTableOperations;
 ...
 */
public class TarimCatalog extends BaseMetastoreCatalog implements Closeable, SupportsNamespaces, Configurable {
    ...
    public TarimTable loadTarimTable(TableIdentifier identifier, Long newSnapshotId){

        TableOperations ops = newTarimTableOps(identifier, newSnapshotId);
        return new TarimTable(ops, fullTableName(name(), identifier));
    }
    @Override
    ...
    protected TableOperations newTableOps(TableIdentifier identifier) {
        return new TarimTableOperations(new Path(this.defaultWarehouseLocation(identifier)), this.fileIO, this.conf, this.lockManager, 0L);
    }
    protected TableOperations newTarimTableOps(TableIdentifier identifier, Long newSnapshotId) {
        return new TarimTableOperations(new Path(this.defaultWarehouseLocation(identifier)), this.fileIO, this.conf, this.lockManager, newSnapshotId);
    }
