...
public class YamlLoader {
    ...
    public static Status loadMetaConfig(String filename, KVMetadata metadata) {
        ...
        if(metadata == null){
            ...
            TLog.error("yaml file load faild: metadata is null. filename: " + filename);
        ...
        TLog.debug("MetaConfig: " + metadata.toString());
    ...
    public static Status loadDNodeConfig(String filename, KVLocalMetadata metadata) {
        ...
        if(metadata == null){
            TLog.error("yaml file load faild: localMetaConf is null. filename: " + filename);
            return Status.NULL_POINTER;
        }
        ...
        TLog.debug("local metadata: " + metadata.toString());
